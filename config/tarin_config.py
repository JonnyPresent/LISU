...
def get_arguments(argv):
    ...
    parser.add_argument('--save_model_path', type=str, default=r'ckpt/resnet', help='path to save trained model')
    parser.add_argument('--visualization_path', type=str, default=r'cat_image/resnet')
