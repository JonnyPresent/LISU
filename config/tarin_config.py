...
def get_arguments(argv):
    ...
    parser.add_argument('--pretrained_path', type=str, default=r'ckpt/resnet-snr-syn/resnet-snr-syn_ms0.4960_epoch50_40.pth', help='')
    ...
    parser.add_argument('--start_epoch', type=int, default=40, help='Start counting epochs from this number')
    parser.add_argument('--batch_size', type=int, default=8, help='Number of images in each batch')  # fifo 中需=4r
