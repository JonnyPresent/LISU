...
def get_arguments(argv):
    ...
    parser.add_argument('--pretrained_resnet_path', type=str, default=r'ckpt/res-fifo/epoch100.pth', help='')

    parser.add_argument('--save_model_path', type=str, default=r'ckpt/res-fifo', help='path to save trained model')
    parser.add_argument('--visualization_path', type=str, default=r'cat_image/res-fifo')
